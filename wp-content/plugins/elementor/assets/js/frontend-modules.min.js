      ...
      t.default = class FloatingBarDomHelper {
        ...
        maybeMoveToTop() {
          ...
          if (elementorFrontend.isEditMode()) t.classList.add("is-sticky");
            ...
            e.dataset.widget_type.startsWith("floating-bars") &&
            t.classList.contains("has-vertical-position-top") &&
            !t.classList.contains("is-sticky")
          ) {
      ...
      class FloatingBarsHandler extends s.default {
        ...
        bindEvents() {
          this.elements.closeButton &&
            this.elements.closeButton.addEventListener(
              "click",
              this.closeFloatingBar.bind(this)
            ),
            this.elements.ctaButton &&
            ...
            this.hasStickyElements() &&
              window.addEventListener(
                "resize",
                this.handleStickyElements.bind(this)
              );
        }
        isStickyTop() {
          const { isSticky: e, hasVerticalPositionTop: t } =
            this.getSettings("constants");
          return (
            this.elements.main.classList.contains(e) &&
            this.elements.main.classList.contains(t)
          );
        }
        isStickyBottom() {
          const { isSticky: e, hasVerticalPositionBottom: t } =
            this.getSettings("constants");
          return (
            this.elements.main.classList.contains(e) &&
            this.elements.main.classList.contains(t)
        ...
        focusOnLoad() {
          this.elements.main.setAttribute("tabindex", "0"),
            this.elements.main.focus({ focusVisible: !0 });
        }
        applyBodyPadding() {
        ...
        handleStickyElements() {
          const e = this.elements.main.offsetHeight,
            ...
            n = document.querySelectorAll(
              ".elementor-sticky:not(.elementor-sticky__spacer)"
            );
          0 !== n.length &&
            (n.forEach((n) => {
              ...
              this.isStickyTop() && r
                ? t.length
                  ? (n.style.top = `${e + t.height()}px`)
                  : (n.style.top = `${e}px`)
                : this.isStickyBottom() && o && (n.style.bottom = `${e}px`),
                elementorFrontend.isEditMode() &&
                  (r
                    ? (n.style.top = this.isStickyTop() ? `${e}px` : "0px")
                    : o &&
                      (n.style.bottom = this.isStickyBottom()
                        ? `${e}px`
                        : "0px"));
            }),
            document
              .querySelectorAll(".elementor-sticky__spacer")
              .forEach((t) => {
        ...
        closeFloatingBar() {
          ...
          elementorFrontend.isEditMode() ||
            ...
            this.hasStickyElements()
              ...
              : this.isStickyTop() && this.removeBodyPadding());
        }
        ...
        initDefaultState() {
          ...
          this.isStickyTop() && this.handleWPAdminBar(),
            this.hasStickyElements()
              ? this.handleStickyElements()
              : this.isStickyTop() && this.applyBodyPadding(),
            !this.elements.main ||
              this.elements.ctaButton.classList.contains(e) ||
              elementorFrontend.isEditMode() ||
              this.focusOnLoad();
        }
        setupInnerContainer() {
          this.elements.main
            .closest(".e-con-inner")
            .classList.add("e-con-inner--floating-bars"),
            this.elements.main
              .closest(".e-con")
              .classList.add("e-con--floating-bars");
        }
        onInit() {
          const { hasEntranceAnimation: e } = this.getSettings("constants");
          super.onInit(...arguments),
    ...
    5877: (e, t, n) => {
      ...
      class ContactButtonsHandler extends s.default {
        ...
        setupInnerContainer() {
          this.elements.main
            .closest(".e-con-inner")
            .classList.add("e-con-inner--floating-buttons");
        }
        onInit() {
          const { hasEntranceAnimation: e } = this.getSettings("constants");
          super.onInit(...arguments),
    ...
    4380: (e, t, n) => {
      ...
      class ClickTrackingHandler extends r.default {
        ...
        getDefaultElements() {
          ...
          return {
            contentWrapper: this.$element[0].querySelector(e.contentWrapper),
            contentWrapperFloatingBars: this.$element[0].querySelector(
              e.contentWrapperFloatingBars
            ),
          };
        }
        bindEvents() {
          this.elements.contentWrapper &&
            ...
            this.elements.contentWrapperFloatingBars &&
              this.elements.contentWrapperFloatingBars.addEventListener(
                "click",
                this.onChatButtonTrackClick.bind(this)
              ),
        ...
        onChatButtonTrackClick(e) {
          ...
          (t.matches(n.contactButtonCore) ||
            t.closest(n.contactButtonCore) ||
            t.matches(n.floatingBarCTAButton) ||
            t.closest(n.floatingBarCTAButton)) &&
